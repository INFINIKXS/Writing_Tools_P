...
const SectionWithMockup = ({
    ...
    return (
        <section className="relative py-24 md:py-48 bg-slate-50 dark:bg-black overflow-hidden transition-colors duration-300">
                ...
                >
                    ...
                    >
                         <div className="space-y-2 md:space-y-1">
                            <h2 className="text-slate-900 dark:text-white text-3xl md:text-[40px] font-semibold leading-tight md:leading-[53px]">
                                {title}
                            </h2>
                        </div>

                        <p className="text-slate-600 dark:text-[#868f97] text-sm md:text-[15px] leading-6">
                            {description}
                        </p>
                    </motion.div>
