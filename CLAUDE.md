...
## Pre-Flight Check & Global Rules
*   **MANDATORY**: On your very first turn of any session, you MUST immediately load, read, and strictly adhere to the global rules located at `C:\Users\Paradox-Labs\.gemini\antigravity\.antigravityrules`.
*   **MANDATORY**: Perform the pre-flight Graphiti Developer Memory check on turn 1 to query the Neo4j database and construct the Developer Memory Status report.
