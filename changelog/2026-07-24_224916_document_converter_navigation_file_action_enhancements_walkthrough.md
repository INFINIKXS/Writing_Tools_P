---
archived: 2026-07-24T22:49:16.081467
...
- **Table & Logo Preservation**: `_run_ocr_to_word_sync` uses PyMuPDF (`page.find_tables()`, `page.get_images()`) to detect native tables and extract embedded logos/diagrams, inserting native formatted tables (`tbl.style = 'Table Grid'`) and images directly into the output `.docx` Word document (`python-docx`).
